...
def makeLatexFile_original(var, CR, year):

    submitFile = open(os.path.join("png_images", str(var)+"_"+str(CR)+"_"+str(year)+"_original.tex"),"w")#"runCombine.sh","w")
    submitFile.write('''\documentclass{article}
    \usepackage[utf8]{inputenc}
    ...
    submitFile.write("\includegraphics[width =\\textwidth]{plots/"+str(var)+"_original_"+str(CR)+"_muonmuon_"+str(year)+".pdf}")
    ...
    submitFile.write("\includegraphics[width =\\textwidth]{plots/"+str(var)+"_original_"+str(CR)+"_muonelectron_"+str(year)+".pdf}")
    ...
    submitFile.write("\includegraphics[width =\\textwidth]{plots/"+str(var)+"_original_"+str(CR)+"_electronelectron_"+str(year)+".pdf}")
    ...
    submitFile.write("\includegraphics[width =\\textwidth]{plots/"+str(var)+"_original_"+str(CR)+"_electronmuon_"+str(year)+".pdf}")
...
variables = [
            ...
            "EventObservables_nominal_mT_met_lep", "dilepton_mass",
            ...
            "selectedJets_nominal_eta", "bdt_score", "PV_npvs", "PV_npvsGood",
